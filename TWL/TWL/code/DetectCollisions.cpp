...
{
	// ==================================================================================
	// Create an area around the character
	// that is used to do collision detection
	// Only do collision detection inside this area
	// no point doing collision detection on a block
	// that is hundreds or thousands of pixels away from the character
